...
## 적용 스킬
- [네이밍 규칙](frontend/.claude/skills/convention-naming/SKILL.md)
- [프로젝트 구조](frontend/.claude/skills/convention-project-structure/SKILL.md)
- [컴포넌트 설계](frontend/.claude/skills/convention-component/SKILL.md)
- [상태관리](frontend/.claude/skills/convention-state/SKILL.md)
- [TDD](frontend/.claude/skills/convention-tdd/SKILL.md)
